...
#
#  $ bin/test -s db.connect -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src db.connect.testing.DB_CONNECT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/db/connect/tests/robot/test_example.robot
#
